...
public:
  ...
  _CCCL_REQUIRES(::cuda::mr::synchronous_resource<_Resource> _CCCL_AND __buffer_compatible_env<_Env>)
  _CCCL_HIDE_FROM_ABI
  async_buffer(::cuda::stream_ref __stream, _Resource&& __resource, [[maybe_unused]] const _Env& __env = {})
  ...
  _CCCL_TEMPLATE(class _Resource, class _Env = ::cuda::std::execution::env<>)
  _CCCL_REQUIRES(::cuda::mr::synchronous_resource<::cuda::std::decay_t<_Resource>> _CCCL_AND __buffer_compatible_env<_Env>)
  ...
  _CCCL_HIDE_FROM_ABI async_buffer(
    ...
    [[maybe_unused]] const _Env& __env = {})
      : __buf_(::cuda::experimental::__adapt_if_synchronous(::cuda::std::forward<_Resource>(__resource)), __stream, __ilist.size())
  {
  ...
  _CCCL_HIDE_FROM_ABI async_buffer(
    ::cuda::stream_ref __stream, _Resource&& __resource, _Range&& __range, [[maybe_unused]] const _Env& __env = {})
      : __buf_(::cuda::experimental::__adapt_if_synchronous(::cuda::std::forward<_Resource>(__resource)),
               __stream,
...
_CCCL_TEMPLATE(class _Tp, class _FirstProperty, class... _RestProperties, class _Resource, class... _SourceProperties, class _Env = ::cuda::std::execution::env<>)
_CCCL_REQUIRES(::cuda::mr::synchronous_resource_with<::cuda::std::decay_t<_Resource>, _FirstProperty, _RestProperties...> _CCCL_AND __buffer_compatible_env<_Env>)
async_buffer<_Tp, _FirstProperty, _RestProperties...> make_async_buffer(
  stream_ref __stream,
  _Resource&& __mr,
  const async_buffer<_Tp, _SourceProperties...>& __source,
  const _Env& __env = {})
{
  async_buffer<_Tp, _FirstProperty, _RestProperties...> __res{__stream, ::cuda::std::forward<_Resource>(__mr), __source.size(), no_init, __env};
...
_CCCL_REQUIRES(::cuda::mr::synchronous_resource<::cuda::std::decay_t<_Resource>> _CCCL_AND __has_default_queries<_Resource>)
...
_CCCL_TEMPLATE(class _Tp, class _FirstProperty, class... _RestProperties, class _Resource, class _Env = ::cuda::std::execution::env<>)
_CCCL_REQUIRES(::cuda::mr::synchronous_resource_with<::cuda::std::decay_t<_Resource>, _FirstProperty, _RestProperties...> _CCCL_AND __buffer_compatible_env<_Env>)
async_buffer<_Tp, _FirstProperty, _RestProperties...>
make_async_buffer(stream_ref __stream, _Resource&& __mr, const _Env& __env = {})
{
  return async_buffer<_Tp, _FirstProperty, _RestProperties...>{__stream, ::cuda::std::forward<_Resource>(__mr), __env};
}

_CCCL_TEMPLATE(class _Tp, class _Resource, class _Env = ::cuda::std::execution::env<>)
_CCCL_REQUIRES(::cuda::mr::synchronous_resource<::cuda::std::decay_t<_Resource>> _CCCL_AND __has_default_queries<_Resource> _CCCL_AND
...
_CCCL_REQUIRES(::cuda::mr::synchronous_resource_with<::cuda::std::decay_t<_Resource>, _FirstProperty, _RestProperties...> _CCCL_AND __buffer_compatible_env<_Env>)
async_buffer<_Tp, _FirstProperty, _RestProperties...> make_async_buffer(
  stream_ref __stream, _Resource&& __mr, size_t __size, const _Tp& __value, const _Env& __env = {})
{
  auto __res = async_buffer<_Tp, _FirstProperty, _RestProperties...>{__stream, ::cuda::std::forward<_Resource>(__mr), __size, no_init};
  __fill_n<_Tp, !::cuda::mr::__is_device_accessible<_FirstProperty, _RestProperties...>>(
...
async_buffer<_Tp, _FirstProperty, _RestProperties...> make_async_buffer(
  ...
  const _Env& __env = {})
{
  return async_buffer<_Tp, _FirstProperty, _RestProperties...>{__stream, ::cuda::std::forward<_Resource>(__mr), __size, ::cuda::experimental::no_init, __env};
}
...
_CCCL_TEMPLATE(class _Tp, class _FirstProperty, class... _RestProperties, class _Resource, class _Iter, class _Env = ::cuda::std::execution::env<>)
_CCCL_REQUIRES(::cuda::mr::synchronous_resource_with<::cuda::std::decay_t<_Resource>, _FirstProperty, _RestProperties...> _CCCL_AND __buffer_compatible_env<_Env> _CCCL_AND ::cuda::std::__has_forward_traversal<_Iter>)
async_buffer<_Tp, _FirstProperty, _RestProperties...> make_async_buffer(
  stream_ref __stream, _Resource&& __mr, _Iter __first, _Iter __last, const _Env& __env = {})
{
  return async_buffer<_Tp, _FirstProperty, _RestProperties...>{__stream, ::cuda::std::forward<_Resource>(__mr), __first, __last, __env};
}

_CCCL_TEMPLATE(class _Tp, class _Resource, class _Iter, class _Env = ::cuda::std::execution::env<>)
_CCCL_REQUIRES(::cuda::mr::synchronous_resource<::cuda::std::decay_t<_Resource>> _CCCL_AND
...
async_buffer<_Tp, _FirstProperty, _RestProperties...> make_async_buffer(
  ...
  const _Env& __env = {})
{
  return async_buffer<_Tp, _FirstProperty, _RestProperties...>{__stream, ::cuda::std::forward<_Resource>(__mr), __ilist, __env};
}
...
_CCCL_TEMPLATE(class _Tp, class _FirstProperty, class... _RestProperties, class _Resource, class _Range, class _Env = ::cuda::std::execution::env<>)
_CCCL_REQUIRES(::cuda::mr::synchronous_resource_with<::cuda::std::decay_t<_Resource>, _FirstProperty, _RestProperties...> _CCCL_AND __buffer_compatible_env<_Env> _CCCL_AND ::cuda::std::ranges::forward_range<_Range>)
async_buffer<_Tp, _FirstProperty, _RestProperties...>
make_async_buffer(stream_ref __stream, _Resource&& __mr, _Range&& __range, const _Env& __env = {})
{
  return async_buffer<_Tp, _FirstProperty, _RestProperties...>{__stream, ::cuda::std::forward<_Resource>(__mr), ::cuda::std::forward<_Range>(__range), __env};
}
