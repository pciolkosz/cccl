...
C2H_CCCLRT_TEST("cudax::async_buffer constructors with legacy resource", "[container][async_buffer]")
{
  cudax::stream stream{cuda::device_ref{0}};
  cudax::legacy_pinned_memory_resource resource;
  ::cuda::std::initializer_list<int> input{-1, 12, 1337, 0, 12, 1};
  cudax::async_buffer<int, cuda::mr::device_accessible> buffer{stream, resource, input};
  ...
  cudax::async_buffer<int, cuda::mr::host_accessible> buffer2{stream, resource, input};
  auto buf2 = cudax::make_async_buffer(stream, resource, buffer2);
...
C2H_CCCLRT_TEST("cudax::make_async_buffer narrowing properties", "[container][async_buffer]")
{
  auto resource = cudax::pinned_memory_resource{};
  cudax::stream stream{cuda::device_ref{0}};
