...
#ifndef _CUDA__MEMORY_RESOURCE_ANY_RESOURCE_H
#define _CUDA__MEMORY_RESOURCE_ANY_RESOURCE_H
    ...
    , __with_try_get_property<any_synchronous_resource<_Properties...>>
{
  ...
  _LIBCUDACXX_DELEGATE_CONSTRUCTORS(
    any_synchronous_resource, ::cuda::__basic_any, __iresource<_Properties...>);
...
private:
  static_assert(::cuda::mr::__contains_execution_space_property<_Properties...>,
                "The properties of cuda::any_synchronous_resource must contain at least one execution "
                "space "
                "property!");
...
private:
  static_assert(::cuda::mr::__contains_execution_space_property<_Properties...>,
                "The properties of cuda::any_resource must contain at least one execution space "
                "property!");
    ...
    , __with_try_get_property<synchronous_resource_ref<_Properties...>>
{
  // Inherit constructors from __basic_any
  _LIBCUDACXX_DELEGATE_CONSTRUCTORS(
    synchronous_resource_ref, ::cuda::__basic_any, __iresource<_Properties...>&);
  ...
  {
    __base::__set_ref(__other.__vptr_, __other.__optr_);
    return *this;
  }
...
private:
  static_assert(::cuda::mr::__contains_execution_space_property<_Properties...>,
                "The properties of cuda::synchronous_resource_ref must contain at least one execution "
                "space "
                "property!");
  using __base::interface;
};
...
private:
  static_assert(::cuda::mr::__contains_execution_space_property<_Properties...>,
                "The properties of cuda::resource_ref must contain at least one execution space "
                "property!");
