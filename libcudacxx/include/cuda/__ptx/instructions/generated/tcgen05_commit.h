...
_CCCL_DEVICE static inline void tcgen05_commit(
  ...
  ::cuda::std::uint32_t __ctaMask)
{
  static_assert(__cta_group == cta_group_1 || __cta_group == cta_group_2, "");
    if constexpr (__cta_group == cta_group_1) {
      asm volatile (
        "tcgen05.commit.cta_group::1.mbarrier::arrive::one.sync_restrict::shared::read::mma::a.shared::cluster.multicast::cluster::32b.b64 [%0], %1;"
        :
        : "r"(__as_ptr_dsmem(__smem_bar)),
          "r"(__ctaMask)
        : "memory"
      ...
      asm volatile (
        "tcgen05.commit.cta_group::2.mbarrier::arrive::one.sync_restrict::shared::read::mma::a.shared::cluster.multicast::cluster::32b.b64 [%0], %1;"
        :
        : "r"(__as_ptr_dsmem(__smem_bar)),
          "r"(__ctaMask)
        : "memory"
