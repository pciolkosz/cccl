  ...
  const ::cuda::std::uint32_t& __phaseParity)
{
    ...
    asm (
      "{\n\t"
      ".reg .pred P_OUT; \n\t"
      "mbarrier.test_wait.parity.shared.b64 P_OUT, [%1], %2; \n\t"
  ...
  static_assert(__scope == scope_cta || __scope == scope_cluster, "");
    ...
    if constexpr (__scope == scope_cta) {
      asm (
        "{\n\t"
        ".reg .pred P_OUT; \n\t"
        "mbarrier.test_wait.parity.acquire.cta.shared::cta.b64 P_OUT, [%1], %2; \n\t"
        "selp.b32 %0, 1, 0, P_OUT; \n"
        "}"
        : "=r"(__waitComplete)
        : "r"(__as_ptr_smem(__addr)),
      ...
      asm (
        "{\n\t"
        ".reg .pred P_OUT; \n\t"
        "mbarrier.test_wait.parity.acquire.cluster.shared::cta.b64 P_OUT, [%1], %2; \n\t"
        "selp.b32 %0, 1, 0, P_OUT; \n"
        "}"
        : "=r"(__waitComplete)
        : "r"(__as_ptr_smem(__addr)),
  ...
  static_assert(__scope == scope_cta || __scope == scope_cluster, "");
    ...
    if constexpr (__sem == sem_acquire && __scope == scope_cta) {
      asm (
        ...
        "mbarrier.test_wait.parity.phase_type::primary.acquire.cta.shared::cta.b64 P_OUT_waitComplete|P_OUT_isReportSeen, [%2], %3; \n\t"
      ...
      asm (
        ...
        ".reg .pred P_OUT_waitComplete; \n\t"
        ".reg .pred P_OUT_isReportSeen; \n\t"
        "mbarrier.test_wait.parity.phase_type::primary.acquire.cluster.shared::cta.b64 P_OUT_waitComplete|P_OUT_isReportSeen, [%2], %3; \n\t"
        "selp.b32 %0, 1, 0, P_OUT_waitComplete; \n\t"
        "selp.b32 %1, 1, 0, P_OUT_isReportSeen; \n"
        "}"
        : "=r"(__waitComplete),
      ...
      asm (
        ...
        ".reg .pred P_OUT_waitComplete; \n\t"
        ".reg .pred P_OUT_isReportSeen; \n\t"
        "mbarrier.test_wait.parity.phase_type::primary.relaxed.cta.shared::cta.b64 P_OUT_waitComplete|P_OUT_isReportSeen, [%2], %3; \n\t"
        "selp.b32 %0, 1, 0, P_OUT_waitComplete; \n\t"
        "selp.b32 %1, 1, 0, P_OUT_isReportSeen; \n"
        "}"
        : "=r"(__waitComplete),
      ...
      asm (
        ...
        ".reg .pred P_OUT_waitComplete; \n\t"
        ".reg .pred P_OUT_isReportSeen; \n\t"
        "mbarrier.test_wait.parity.phase_type::primary.relaxed.cluster.shared::cta.b64 P_OUT_waitComplete|P_OUT_isReportSeen, [%2], %3; \n\t"
        "selp.b32 %0, 1, 0, P_OUT_waitComplete; \n\t"
        "selp.b32 %1, 1, 0, P_OUT_isReportSeen; \n"
        "}"
        : "=r"(__waitComplete),
  ...
  static_assert(__scope == scope_cta || __scope == scope_cluster, "");
    ...
    if constexpr (__sem == sem_acquire && __scope == scope_cta) {
      asm (
        "{\n\t"
        ".reg .pred P_OUT; \n\t"
        "mbarrier.test_wait.parity.phase_type::conditional.acquire.cta.shared::cta.b64 P_OUT, [%1], %2; \n\t"
        "selp.b32 %0, 1, 0, P_OUT; \n"
        "}"
        : "=r"(__waitComplete)
        : "r"(__as_ptr_smem(__addr)),
      ...
      asm (
        "{\n\t"
        ".reg .pred P_OUT; \n\t"
        "mbarrier.test_wait.parity.phase_type::conditional.acquire.cluster.shared::cta.b64 P_OUT, [%1], %2; \n\t"
        "selp.b32 %0, 1, 0, P_OUT; \n"
        "}"
        : "=r"(__waitComplete)
        : "r"(__as_ptr_smem(__addr)),
      ...
      asm (
        "{\n\t"
        ".reg .pred P_OUT; \n\t"
        "mbarrier.test_wait.parity.phase_type::conditional.relaxed.cta.shared::cta.b64 P_OUT, [%1], %2; \n\t"
        "selp.b32 %0, 1, 0, P_OUT; \n"
        "}"
        : "=r"(__waitComplete)
        : "r"(__as_ptr_smem(__addr)),
      ...
      asm (
        "{\n\t"
        ".reg .pred P_OUT; \n\t"
        "mbarrier.test_wait.parity.phase_type::conditional.relaxed.cluster.shared::cta.b64 P_OUT, [%1], %2; \n\t"
        "selp.b32 %0, 1, 0, P_OUT; \n"
        "}"
        : "=r"(__waitComplete)
        : "r"(__as_ptr_smem(__addr)),
