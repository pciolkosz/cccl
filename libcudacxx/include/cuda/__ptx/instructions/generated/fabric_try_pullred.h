  ...
  ::cuda::std::uint64_t* __smem_bar)
{
  ...
  // __space == space_shared (due to parameter type constraint)
    asm (
      "fabric.try_pullred.async.multimem.shared::cta.mbarrier::complete_tx::bytes.mbarrier::report::fabric.relaxed.sys.and.b32.sync [%0], [%1, %2], %3, [%4], 0xFFFFFFFF;"
      :
  ...
  ::cuda::std::uint64_t* __smem_bar)
{
  ...
  // __space == space_shared (due to parameter type constraint)
    asm (
      "fabric.try_pullred.async.multimem.shared::cta.mbarrier::complete_tx::bytes.mbarrier::report::fabric.relaxed.sys.xor.b32.sync [%0], [%1, %2], %3, [%4], 0xFFFFFFFF;"
      :
      : "r"(__as_ptr_smem(__dst)),
        "r"(__srcLeId),
        "l"(__srcDataOff),
  ...
  ::cuda::std::uint64_t* __smem_bar)
{
  ...
  // __space == space_shared (due to parameter type constraint)
    asm (
      "fabric.try_pullred.async.multimem.shared::cta.mbarrier::complete_tx::bytes.mbarrier::report::fabric.relaxed.sys.or.b32.sync [%0], [%1, %2], %3, [%4], 0xFFFFFFFF;"
      :
      : "r"(__as_ptr_smem(__dst)),
        "r"(__srcLeId),
        "l"(__srcDataOff),
  ...
  ::cuda::std::uint64_t* __smem_bar)
{
  ...
  // __space == space_shared (due to parameter type constraint)
    asm (
      "fabric.try_pullred.async.multimem.shared::cta.mbarrier::complete_tx::bytes.mbarrier::report::fabric.relaxed.sys.and.b64.sync [%0], [%1, %2], %3, [%4], 0xFFFFFFFF;"
      :
      : "r"(__as_ptr_smem(__dst)),
        "r"(__srcLeId),
        "l"(__srcDataOff),
  ...
  ::cuda::std::uint64_t* __smem_bar)
{
  ...
  // __space == space_shared (due to parameter type constraint)
    asm (
      "fabric.try_pullred.async.multimem.shared::cta.mbarrier::complete_tx::bytes.mbarrier::report::fabric.relaxed.sys.xor.b64.sync [%0], [%1, %2], %3, [%4], 0xFFFFFFFF;"
      :
      : "r"(__as_ptr_smem(__dst)),
        "r"(__srcLeId),
        "l"(__srcDataOff),
  ...
  ::cuda::std::uint64_t* __smem_bar)
{
  ...
  // __space == space_shared (due to parameter type constraint)
    asm (
      "fabric.try_pullred.async.multimem.shared::cta.mbarrier::complete_tx::bytes.mbarrier::report::fabric.relaxed.sys.or.b64.sync [%0], [%1, %2], %3, [%4], 0xFFFFFFFF;"
      :
      : "r"(__as_ptr_smem(__dst)),
        "r"(__srcLeId),
        "l"(__srcDataOff),
  ...
  ::cuda::std::uint64_t* __smem_bar)
{
  ...
  // __space == space_shared (due to parameter type constraint)
    asm (
      "fabric.try_pullred.async.multimem.shared::cta.mbarrier::complete_tx::bytes.mbarrier::report::fabric.relaxed.sys.min.u32.sync [%0], [%1, %2], %3, [%4], 0xFFFFFFFF;"
      :
      : "r"(__as_ptr_smem(__dst)),
        "r"(__srcLeId),
        "l"(__srcDataOff),
  ...
  ::cuda::std::uint64_t* __smem_bar)
{
  ...
  // __space == space_shared (due to parameter type constraint)
    asm (
      "fabric.try_pullred.async.multimem.shared::cta.mbarrier::complete_tx::bytes.mbarrier::report::fabric.relaxed.sys.max.u32.sync [%0], [%1, %2], %3, [%4], 0xFFFFFFFF;"
      :
      : "r"(__as_ptr_smem(__dst)),
        "r"(__srcLeId),
        "l"(__srcDataOff),
  ...
  ::cuda::std::uint64_t* __smem_bar)
{
  ...
  // __space == space_shared (due to parameter type constraint)
    asm (
      "fabric.try_pullred.async.multimem.shared::cta.mbarrier::complete_tx::bytes.mbarrier::report::fabric.relaxed.sys.min.s32.sync [%0], [%1, %2], %3, [%4], 0xFFFFFFFF;"
      :
      : "r"(__as_ptr_smem(__dst)),
        "r"(__srcLeId),
        "l"(__srcDataOff),
  ...
  ::cuda::std::uint64_t* __smem_bar)
{
  ...
  // __space == space_shared (due to parameter type constraint)
    asm (
      "fabric.try_pullred.async.multimem.shared::cta.mbarrier::complete_tx::bytes.mbarrier::report::fabric.relaxed.sys.max.s32.sync [%0], [%1, %2], %3, [%4], 0xFFFFFFFF;"
      :
      : "r"(__as_ptr_smem(__dst)),
        "r"(__srcLeId),
        "l"(__srcDataOff),
  ...
  ::cuda::std::uint64_t* __smem_bar)
{
  ...
  // __space == space_shared (due to parameter type constraint)
    asm (
      "fabric.try_pullred.async.multimem.shared::cta.mbarrier::complete_tx::bytes.mbarrier::report::fabric.relaxed.sys.min.u64.sync [%0], [%1, %2], %3, [%4], 0xFFFFFFFF;"
      :
      : "r"(__as_ptr_smem(__dst)),
        "r"(__srcLeId),
        "l"(__srcDataOff),
  ...
  ::cuda::std::uint64_t* __smem_bar)
{
  ...
  // __space == space_shared (due to parameter type constraint)
    asm (
      "fabric.try_pullred.async.multimem.shared::cta.mbarrier::complete_tx::bytes.mbarrier::report::fabric.relaxed.sys.max.u64.sync [%0], [%1, %2], %3, [%4], 0xFFFFFFFF;"
      :
      : "r"(__as_ptr_smem(__dst)),
        "r"(__srcLeId),
        "l"(__srcDataOff),
  ...
  ::cuda::std::uint64_t* __smem_bar)
{
  ...
  // __space == space_shared (due to parameter type constraint)
    asm (
      "fabric.try_pullred.async.multimem.shared::cta.mbarrier::complete_tx::bytes.mbarrier::report::fabric.relaxed.sys.min.s64.sync [%0], [%1, %2], %3, [%4], 0xFFFFFFFF;"
      :
      : "r"(__as_ptr_smem(__dst)),
        "r"(__srcLeId),
        "l"(__srcDataOff),
  ...
  ::cuda::std::uint64_t* __smem_bar)
{
  ...
  // __space == space_shared (due to parameter type constraint)
    asm (
      "fabric.try_pullred.async.multimem.shared::cta.mbarrier::complete_tx::bytes.mbarrier::report::fabric.relaxed.sys.max.s64.sync [%0], [%1, %2], %3, [%4], 0xFFFFFFFF;"
      :
      : "r"(__as_ptr_smem(__dst)),
        "r"(__srcLeId),
        "l"(__srcDataOff),
  ...
  ::cuda::std::uint64_t* __smem_bar)
{
  ...
  // __space == space_shared (due to parameter type constraint)
    asm (
      "fabric.try_pullred.async.multimem.shared::cta.mbarrier::complete_tx::bytes.mbarrier::report::fabric.relaxed.sys.min.f16.sync [%0], [%1, %2], %3, [%4], 0xFFFFFFFF;"
      :
      : "r"(__as_ptr_smem(__dst)),
        "r"(__srcLeId),
        "l"(__srcDataOff),
  ...
  ::cuda::std::uint64_t* __smem_bar)
{
  ...
  // __space == space_shared (due to parameter type constraint)
    asm (
      "fabric.try_pullred.async.multimem.shared::cta.mbarrier::complete_tx::bytes.mbarrier::report::fabric.relaxed.sys.max.f16.sync [%0], [%1, %2], %3, [%4], 0xFFFFFFFF;"
      :
      : "r"(__as_ptr_smem(__dst)),
        "r"(__srcLeId),
        "l"(__srcDataOff),
  ...
  ::cuda::std::uint64_t* __smem_bar)
{
  ...
  // __space == space_shared (due to parameter type constraint)
    asm (
      "fabric.try_pullred.async.multimem.shared::cta.mbarrier::complete_tx::bytes.mbarrier::report::fabric.relaxed.sys.min.bf16.sync [%0], [%1, %2], %3, [%4], 0xFFFFFFFF;"
      :
      : "r"(__as_ptr_smem(__dst)),
        "r"(__srcLeId),
        "l"(__srcDataOff),
  ...
  ::cuda::std::uint64_t* __smem_bar)
{
  ...
  // __space == space_shared (due to parameter type constraint)
    asm (
      "fabric.try_pullred.async.multimem.shared::cta.mbarrier::complete_tx::bytes.mbarrier::report::fabric.relaxed.sys.max.bf16.sync [%0], [%1, %2], %3, [%4], 0xFFFFFFFF;"
      :
      : "r"(__as_ptr_smem(__dst)),
        "r"(__srcLeId),
        "l"(__srcDataOff),
  ...
  ::cuda::std::uint64_t* __smem_bar)
{
  ...
  // __space == space_shared (due to parameter type constraint)
    asm (
      "fabric.try_pullred.async.multimem.shared::cta.mbarrier::complete_tx::bytes.mbarrier::report::fabric.relaxed.sys.add.u32.sync [%0], [%1, %2], %3, [%4], 0xFFFFFFFF;"
      :
      : "r"(__as_ptr_smem(__dst)),
        "r"(__srcLeId),
        "l"(__srcDataOff),
  ...
  ::cuda::std::uint64_t* __smem_bar)
{
  ...
  // __space == space_shared (due to parameter type constraint)
    asm (
      "fabric.try_pullred.async.multimem.shared::cta.mbarrier::complete_tx::bytes.mbarrier::report::fabric.relaxed.sys.add.u64.sync [%0], [%1, %2], %3, [%4], 0xFFFFFFFF;"
      :
      : "r"(__as_ptr_smem(__dst)),
        "r"(__srcLeId),
        "l"(__srcDataOff),
  ...
  ::cuda::std::uint64_t* __smem_bar)
{
  ...
  // __space == space_shared (due to parameter type constraint)
    asm (
      "fabric.try_pullred.async.multimem.shared::cta.mbarrier::complete_tx::bytes.mbarrier::report::fabric.relaxed.sys.add.f16.sync [%0], [%1, %2], %3, [%4], 0xFFFFFFFF;"
      :
      : "r"(__as_ptr_smem(__dst)),
        "r"(__srcLeId),
        "l"(__srcDataOff),
  ...
  ::cuda::std::uint64_t* __smem_bar)
{
  ...
  // __space == space_shared (due to parameter type constraint)
    asm (
      "fabric.try_pullred.async.multimem.shared::cta.mbarrier::complete_tx::bytes.mbarrier::report::fabric.relaxed.sys.add.bf16.sync [%0], [%1, %2], %3, [%4], 0xFFFFFFFF;"
      :
      : "r"(__as_ptr_smem(__dst)),
        "r"(__srcLeId),
        "l"(__srcDataOff),
  ...
  ::cuda::std::uint64_t* __smem_bar)
{
  ...
  // __space == space_shared (due to parameter type constraint)
    asm (
      "fabric.try_pullred.async.multimem.shared::cta.mbarrier::complete_tx::bytes.mbarrier::report::fabric.relaxed.sys.add.f32.sync [%0], [%1, %2], %3, [%4], 0xFFFFFFFF;"
      :
      : "r"(__as_ptr_smem(__dst)),
        "r"(__srcLeId),
        "l"(__srcDataOff),
  ...
  ::cuda::std::uint64_t* __smem_bar)
{
  ...
  // __space == space_shared (due to parameter type constraint)
    asm (
      "fabric.try_pullred.async.multimem.shared::cta.mbarrier::complete_tx::bytes.mbarrier::report::fabric.relaxed.sys.add.acc::f32.f16.sync [%0], [%1, %2], %3, [%4], 0xFFFFFFFF;"
      :
      : "r"(__as_ptr_smem(__dst_mem)),
        "r"(__srcLeId),
        "l"(__srcDataOff),
        "r"(__size),
        "r"(__as_ptr_smem(__smem_bar))
  ...
  ::cuda::std::uint64_t* __smem_bar)
{
  ...
  // __space == space_shared (due to parameter type constraint)
    asm (
      "fabric.try_pullred.async.multimem.shared::cta.mbarrier::complete_tx::bytes.mbarrier::report::fabric.relaxed.sys.add.acc::f32.bf16.sync [%0], [%1, %2], %3, [%4], 0xFFFFFFFF;"
      :
      : "r"(__as_ptr_smem(__dst_mem)),
        "r"(__srcLeId),
        "l"(__srcDataOff),
