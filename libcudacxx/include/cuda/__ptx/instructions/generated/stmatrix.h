...
_CCCL_DEVICE static inline void stmatrix_m8n8(
  _B16* __gmem_ptr,
  const ::cuda::std::uint32_t (&__input)[1])
{
    asm volatile (
      "stmatrix.sync.aligned.m8n8.x1.shared.b16 [%0], {%1};"
      :
      : "r"(__as_ptr_smem(__gmem_ptr)),
        "r"(__input[0])
      : "memory"
    );
}
...
_CCCL_DEVICE static inline void stmatrix_m8n8(
  _B16* __gmem_ptr,
  const ::cuda::std::uint32_t (&__input)[2])
{
    asm volatile (
...
_CCCL_DEVICE static inline void stmatrix_m8n8(
  _B16* __gmem_ptr,
  const ::cuda::std::uint32_t (&__input)[4])
{
    asm volatile (
...
#if __cccl_ptx_isa >= 780
template <typename _B16, ::cuda::std::enable_if_t<sizeof(_B16) == 2, bool> = true>
_CCCL_DEVICE static inline void stmatrix_m8n8_trans(
  _B16* __gmem_ptr,
  const ::cuda::std::uint32_t (&__input)[1])
{
    asm volatile (
...
/*
// stmatrix.sync.aligned.m16n8.x1.trans.shared.b8 [gmem_ptr], input; // PTX ISA 86, SM_100a, SM_100f, SM_103a, SM_103f, SM_107a, SM_107f, SM_110a, SM_110f, SM_120a, SM_120f, SM_121a, SM_121f
...
_CCCL_DEVICE static inline void stmatrix_m16n8_trans(
  _B8* __gmem_ptr,
  const ::cuda::std::uint32_t (&__input)[1])
{
    asm volatile (
...
/*
// stmatrix.sync.aligned.m16n8.x2.trans.shared.b8 [gmem_ptr], input; // PTX ISA 86, SM_100a, SM_100f, SM_103a, SM_103f, SM_107a, SM_107f, SM_110a, SM_110f, SM_120a, SM_120f, SM_121a, SM_121f
template <typename B8, enable_if_t<sizeof(B8) == 1, bool> = true>
__device__ static inline void stmatrix_m16n8_trans(
  B8* gmem_ptr,
  const uint32_t (&input)[2]);
...
/*
// stmatrix.sync.aligned.m16n8.x4.trans.shared.b8 [gmem_ptr], input; // PTX ISA 86, SM_100a, SM_100f, SM_103a, SM_103f, SM_107a, SM_107f, SM_110a, SM_110f, SM_120a, SM_120f, SM_121a, SM_121f
template <typename B8, enable_if_t<sizeof(B8) == 1, bool> = true>
__device__ static inline void stmatrix_m16n8_trans(
  B8* gmem_ptr,
  const uint32_t (&input)[4]);
