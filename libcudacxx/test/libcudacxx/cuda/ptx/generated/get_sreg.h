...
__global__ void test_get_sreg(void ** fn_ptr) {
  ...
  *fn_ptr++ = reinterpret_cast<void*>(static_cast<cuda::std::uint64_t (*)()>(cuda::ptx::get_sreg_gridid));
  ...
  NV_IF_TARGET(NV_PROVIDES_SM_90, (
    ...
    *fn_ptr++ = reinterpret_cast<void*>(static_cast<cuda::std::uint32_t (*)()>(cuda::ptx::get_sreg_nclusterid_x));
  ));
#endif // __cccl_ptx_isa >= 780
  ...
  NV_IF_TARGET(NV_PROVIDES_SM_90, (
    ...
    *fn_ptr++ = reinterpret_cast<void*>(static_cast<cuda::std::uint32_t (*)()>(cuda::ptx::get_sreg_nclusterid_y));
  ));
#endif // __cccl_ptx_isa >= 780
  ...
  NV_IF_TARGET(NV_PROVIDES_SM_90, (
    ...
    *fn_ptr++ = reinterpret_cast<void*>(static_cast<cuda::std::uint32_t (*)()>(cuda::ptx::get_sreg_nclusterid_z));
  ));
#endif // __cccl_ptx_isa >= 780
  ...
  NV_IF_TARGET(NV_PROVIDES_SM_90, (
    ...
    *fn_ptr++ = reinterpret_cast<void*>(static_cast<cuda::std::uint32_t (*)()>(cuda::ptx::get_sreg_cluster_ctaid_x));
  ));
#endif // __cccl_ptx_isa >= 780
  ...
  NV_IF_TARGET(NV_PROVIDES_SM_90, (
    ...
    *fn_ptr++ = reinterpret_cast<void*>(static_cast<cuda::std::uint32_t (*)()>(cuda::ptx::get_sreg_cluster_ctaid_y));
  ));
#endif // __cccl_ptx_isa >= 780
  ...
  NV_IF_TARGET(NV_PROVIDES_SM_90, (
    ...
    *fn_ptr++ = reinterpret_cast<void*>(static_cast<cuda::std::uint32_t (*)()>(cuda::ptx::get_sreg_cluster_ctaid_z));
  ));
#endif // __cccl_ptx_isa >= 780
  ...
  NV_IF_TARGET(NV_PROVIDES_SM_90, (
    ...
    *fn_ptr++ = reinterpret_cast<void*>(static_cast<cuda::std::uint32_t (*)()>(cuda::ptx::get_sreg_cluster_nctaid_x));
  ));
#endif // __cccl_ptx_isa >= 780
  ...
  NV_IF_TARGET(NV_PROVIDES_SM_90, (
    ...
    *fn_ptr++ = reinterpret_cast<void*>(static_cast<cuda::std::uint32_t (*)()>(cuda::ptx::get_sreg_cluster_nctaid_y));
  ));
#endif // __cccl_ptx_isa >= 780
  ...
  NV_IF_TARGET(NV_PROVIDES_SM_90, (
    ...
    *fn_ptr++ = reinterpret_cast<void*>(static_cast<cuda::std::uint32_t (*)()>(cuda::ptx::get_sreg_cluster_nctaid_z));
  ));
#endif // __cccl_ptx_isa >= 780
  ...
  NV_IF_TARGET(NV_PROVIDES_SM_90, (
    ...
    *fn_ptr++ = reinterpret_cast<void*>(static_cast<cuda::std::uint32_t (*)()>(cuda::ptx::get_sreg_cluster_ctarank));
  ));
#endif // __cccl_ptx_isa >= 780
  ...
  NV_IF_TARGET(NV_PROVIDES_SM_90, (
    ...
    *fn_ptr++ = reinterpret_cast<void*>(static_cast<cuda::std::uint32_t (*)()>(cuda::ptx::get_sreg_cluster_nctarank));
  ));
#endif // __cccl_ptx_isa >= 780
  ...
  *fn_ptr++ = reinterpret_cast<void*>(static_cast<cuda::std::uint32_t (*)()>(cuda::ptx::get_sreg_clock));
  ...
  NV_IF_TARGET(NV_PROVIDES_SM_35, (
    ...
    *fn_ptr++ = reinterpret_cast<void*>(static_cast<cuda::std::uint32_t (*)()>(cuda::ptx::get_sreg_globaltimer_lo));
  ));
#endif // __cccl_ptx_isa >= 310
  ...
  NV_IF_TARGET(NV_PROVIDES_SM_35, (
    ...
    *fn_ptr++ = reinterpret_cast<void*>(static_cast<cuda::std::uint32_t (*)()>(cuda::ptx::get_sreg_globaltimer_hi));
  ));
#endif // __cccl_ptx_isa >= 310
  ...
  NV_IF_TARGET(NV_PROVIDES_SM_35, (
    ...
    *fn_ptr++ = reinterpret_cast<void*>(static_cast<cuda::std::uint32_t (*)()>(cuda::ptx::get_sreg_total_smem_size));
  ));
  ...
  NV_IF_TARGET(NV_PROVIDES_SM_90, (
    ...
    *fn_ptr++ = reinterpret_cast<void*>(static_cast<cuda::std::uint32_t (*)()>(cuda::ptx::get_sreg_aggr_smem_size));
  ));
  ...
  NV_IF_TARGET(NV_PROVIDES_SM_35, (
    ...
    *fn_ptr++ = reinterpret_cast<void*>(static_cast<cuda::std::uint32_t (*)()>(cuda::ptx::get_sreg_dynamic_smem_size));
  ));
#endif // __cccl_ptx_isa >= 410
  ...
  NV_IF_TARGET(NV_PROVIDES_SM_50, (
    ...
    *fn_ptr++ = reinterpret_cast<void*>(static_cast<cuda::std::uint64_t (*)()>(cuda::ptx::get_sreg_current_graph_exec));
  ));
