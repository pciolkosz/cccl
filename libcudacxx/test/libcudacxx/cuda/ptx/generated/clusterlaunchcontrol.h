...
__global__ void test_clusterlaunchcontrol(void ** fn_ptr) {
  ...
  NV_IF_TARGET(NV_PROVIDES_SM_100, (
    ...
    *fn_ptr++ = reinterpret_cast<void*>(static_cast<void (*)(void* , cuda::std::uint64_t* )>(cuda::ptx::clusterlaunchcontrol_try_cancel));
  ));
#endif // __cccl_ptx_isa >= 860

#if __cccl_ptx_isa >= 860
  NV_IF_TARGET(NV_HAS_FEATURE_SM_100a, (
      // clusterlaunchcontrol.try_cancel.async.shared::cta.mbarrier::complete_tx::bytes.multicast::cluster::all.b128 [addr], [smem_bar];
      *fn_ptr++ = reinterpret_cast<void*>(static_cast<void (*)(void* , cuda::std::uint64_t* )>(cuda::ptx::clusterlaunchcontrol_try_cancel_multicast));
  ));
  ...
  NV_IF_TARGET(NV_PROVIDES_SM_100, (
    ...
    *fn_ptr++ = reinterpret_cast<void*>(static_cast<bool (*)(longlong2 )>(cuda::ptx::clusterlaunchcontrol_query_cancel_is_canceled));
  ));
#endif // __cccl_ptx_isa >= 860
  ...
  NV_IF_TARGET(NV_PROVIDES_SM_100, (
    ...
    *fn_ptr++ = reinterpret_cast<void*>(static_cast<cuda::std::int32_t (*)(longlong2 )>(cuda::ptx::clusterlaunchcontrol_query_cancel_get_first_ctaid_x));
  ));
#endif // __cccl_ptx_isa >= 860
  ...
  NV_IF_TARGET(NV_PROVIDES_SM_100, (
    ...
    *fn_ptr++ = reinterpret_cast<void*>(static_cast<cuda::std::int32_t (*)(longlong2 )>(cuda::ptx::clusterlaunchcontrol_query_cancel_get_first_ctaid_y));
  ));
#endif // __cccl_ptx_isa >= 860
  ...
  NV_IF_TARGET(NV_PROVIDES_SM_100, (
    ...
    *fn_ptr++ = reinterpret_cast<void*>(static_cast<cuda::std::int32_t (*)(longlong2 )>(cuda::ptx::clusterlaunchcontrol_query_cancel_get_first_ctaid_z));
  ));
#endif // __cccl_ptx_isa >= 860
  ...
  NV_IF_TARGET(NV_PROVIDES_SM_100, (
    ...
    *fn_ptr++ = reinterpret_cast<void*>(static_cast<void (*)(cuda::std::int32_t (&block_dim)[4], longlong2 )>(cuda::ptx::clusterlaunchcontrol_query_cancel_get_first_ctaid));
  ));
#endif // __cccl_ptx_isa >= 860
}
