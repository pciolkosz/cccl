...
__global__ void test_mbarrier_try_wait(void** fn_ptr)
{
    ...
    (
        ...
        * fn_ptr++ = reinterpret_cast<void*>(
          static_cast<bool (*)(cuda::ptx::mbarrier_phase_primary_t,
                               ...
                               bool& isReportSeen,
                               cuda::std::uint64_t*,
                               cuda::std::uint64_t)>(cuda::ptx::mbarrier_try_wait));));
  NV_IF_TARGET(
    NV_PROVIDES_SM_90,
    (
        // mbarrier.try_wait.phase_type::primary.acquire.cluster.shared::cta.b64 waitComplete|isReportSeen, [addr],
        // state;
        * fn_ptr++ = reinterpret_cast<void*>(
          static_cast<bool (*)(cuda::ptx::mbarrier_phase_primary_t,
                               cuda::ptx::sem_acquire_t,
  ...
  NV_IF_TARGET(
    NV_PROVIDES_SM_90,
    (
        // mbarrier.try_wait.phase_type::primary.relaxed.cluster.shared::cta.b64 waitComplete|isReportSeen, [addr],
        // state;
        * fn_ptr++ = reinterpret_cast<void*>(
          static_cast<bool (*)(cuda::ptx::mbarrier_phase_primary_t,
                               cuda::ptx::sem_relaxed_t,
  ...
  NV_IF_TARGET(
    NV_PROVIDES_SM_90,
    (
        // mbarrier.try_wait.phase_type::primary.acquire.cta.shared::cta.b64 waitComplete|isReportSeen, reportValue,
        // [addr], state;
        * fn_ptr++ = reinterpret_cast<void*>(
          static_cast<bool (*)(cuda::ptx::mbarrier_phase_primary_t,
                               cuda::ptx::sem_acquire_t,
                               cuda::ptx::scope_cta_t,
                               bool& isReportSeen,
                               cuda::std::uint32_t& reportValue,
                               cuda::std::uint64_t*,
                               cuda::std::uint64_t)>(cuda::ptx::mbarrier_try_wait));));
  NV_IF_TARGET(
    NV_PROVIDES_SM_90,
    (
        // mbarrier.try_wait.phase_type::primary.acquire.cluster.shared::cta.b64 waitComplete|isReportSeen, reportValue,
        // [addr], state;
        * fn_ptr++ = reinterpret_cast<void*>(
          static_cast<bool (*)(cuda::ptx::mbarrier_phase_primary_t,
                               cuda::ptx::sem_acquire_t,
  ...
  NV_IF_TARGET(
    NV_PROVIDES_SM_90,
    (
        // mbarrier.try_wait.phase_type::primary.relaxed.cta.shared::cta.b64 waitComplete|isReportSeen, reportValue,
        // [addr], state;
        * fn_ptr++ = reinterpret_cast<void*>(
          static_cast<bool (*)(cuda::ptx::mbarrier_phase_primary_t,
                               cuda::ptx::sem_relaxed_t,
  ...
  NV_IF_TARGET(
    NV_PROVIDES_SM_90,
    (
        // mbarrier.try_wait.phase_type::primary.relaxed.cluster.shared::cta.b64 waitComplete|isReportSeen, reportValue,
        // [addr], state;
        * fn_ptr++ = reinterpret_cast<void*>(
          static_cast<bool (*)(cuda::ptx::mbarrier_phase_primary_t,
                               cuda::ptx::sem_relaxed_t,
    ...
    (
        ...
        * fn_ptr++ = reinterpret_cast<void*>(
          static_cast<bool (*)(cuda::ptx::mbarrier_phase_primary_t,
                               ...
                               cuda::std::uint64_t*,
                               cuda::std::uint64_t,
                               cuda::std::uint32_t)>(cuda::ptx::mbarrier_try_wait));));
  NV_IF_TARGET(
    NV_PROVIDES_SM_90,
    (
        // mbarrier.try_wait.phase_type::primary.acquire.cluster.shared::cta.b64 waitComplete|isReportSeen, [addr],
        // state, suspendTimeHint;
        * fn_ptr++ = reinterpret_cast<void*>(
          static_cast<bool (*)(cuda::ptx::mbarrier_phase_primary_t,
                               cuda::ptx::sem_acquire_t,
                               cuda::ptx::scope_cluster_t,
